...
class ExoBoot:
    ...
    def __init__(self, port, baud_rate, idx, log_level, shouldLog, frequency, soft_sensor_data):
        ...
        # soft sensor info
        self.idx_soft_sensor_time = self.idx_other_base + 6
        self.idx_hip_sensor = self.idx_other_base + 7
        self.idx_knee_sensor = self.idx_other_base + 8
        self.idx_mhe_gait = self.idx_other_base + 9
        ...
        self.labels_other = [
            ...
            "Torque Command", "Soft Sensor Time", "Hip Soft Sensor", "Knee Soft Sensor", "MHE Percent Gait"]
...
class Arduino:
    ...
    def __init__(self):
        self.left_sensor_data = [-1, -1, -1]
        self.right_sensor_data = [-1, -1, -1]
